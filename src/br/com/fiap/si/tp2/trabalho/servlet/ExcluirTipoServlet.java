...
/**
 * Servlet implementation class ExcluirTipoServlet
 */
@WebServlet("/ExcluirTipoServlet")
public class ExcluirTipoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExcluirTipoServlet() {
        super();
