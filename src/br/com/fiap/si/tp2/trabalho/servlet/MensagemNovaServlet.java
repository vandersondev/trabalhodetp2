...
/**
 * Servlet implementation class MensagemNovaServlet
 */
@WebServlet("/MensagemNovaServlet")
public class MensagemNovaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MensagemNovaServlet() {
        super();
