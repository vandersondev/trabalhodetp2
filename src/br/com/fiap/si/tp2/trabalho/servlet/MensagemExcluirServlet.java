...
/**
 * Servlet implementation class MensagemExcluirServlet
 */
@WebServlet("/MensagemExcluirServlet")
public class MensagemExcluirServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MensagemExcluirServlet() {
        super();
	...
	protected void req(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user == null) {
			...
			mensagemDao.deleteMensagem(idMensagem);
