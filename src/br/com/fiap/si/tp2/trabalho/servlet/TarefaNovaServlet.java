...
/**
 * Servlet implementation class TarefaNovaServlet
 */
@WebServlet("/TarefaNovaServlet")
public class TarefaNovaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TarefaNovaServlet() {
        super();
    ...
    /**
   	...
   	protected void req(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
   		...
   		if(user == null) {
			...
			request.setAttribute("successCreated", 1);
